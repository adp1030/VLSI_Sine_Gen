...
value="pulse(0 1.8 0.75n 0.75n 0.75n 3n 7.5n)"}
...
.control
  ...
  dowhile run <= mc_runs
    tran 0.1n 1u
    wrdata ~/Documents/VLSI_Sine_Gen/simulation/sim_data/register_dac_single_7_5ns.txt v(Vout+) v(Vout-) v(Vout+)-v(Vout-)
    reset
    let run = run + 1
  end
  quit
