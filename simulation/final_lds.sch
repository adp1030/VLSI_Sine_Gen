...
S {}
E {}
T {16-bit shift register} 350 620 0 0 0.2 0.2 {}
T {DAC} 660 560 0 0 0.2 0.2 {}
T {cascode voltage generator} 510 280 0 0 0.2 0.2 {}
T {output filter} 780 440 0 0 0.2 0.2 {}
N 630 340 650 340 {
lab=#net3}
N 650 340 650 350 {
lab=#net3}
...
C {devices/opin.sym} 470 550 0 0 {name=p11 lab=Vff8}
C {devices/opin.sym} 870 390 0 0 {name=p12 lab=Vout+}
C {devices/opin.sym} 870 410 0 0 {name=p13 lab=Vout-}
...
C {/home/madvlsi/VLSI_Sine_Gen/simulation/filter/filter_lvs.sym} 560 200 0 0 {name=x3}
